...
type InvokeHandler1<TResult extends ScalarType, TArg1 extends ScalarType> = (
...
export const nvl: <T1 extends ScalarType, T2 extends ScalarType>(
...
export const isNull: <T1 extends ScalarType, T2 extends ScalarType>(
  expr: CompatibleExpression<T1>,
  default_value: CompatibleExpression<T2>
...
export const str: InvokeHandler1<string, ScalarType> = makeFunc(
  'scalar',
  'str',
  true
)
