...
export const count: (expr: CompatibleExpression<Scalar> | Star) => Expression<number> = makeInvoke(
  "scalar",
  "count",
  true
);
...
export const sum: <T extends Numeric>(expr: CompatibleExpression<T>) => Expression<T> = makeInvoke(
  "scalar",
  "sum",
  true
);
