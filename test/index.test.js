...
const mock = tslib_1.__importStar(require("mockjs"));
...
describe('MSSQL TESTS', function () {
    ...
    it('db.query(sql: Insert) => @@IDENTITY', async function () {
        ...
        const sql2 = lubejs_1.select(lubejs_1.any()).from('Items').where(lubejs_1.field('fid').eq(__1.IDENTITY));
    ...
    it('select', async function () {
        const x = {
            ...
            FAge: lubejs_1.SORT_DIRECTION.DESC
        };
