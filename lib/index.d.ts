...
export const FUNCTIONS: {
  ...
  max: <T extends number | string>(expr: Expression<T>) => Expression<T>;
  min: <T extends number | string>(expr: Expression<T>) => Expression<T>;
...
export const max: <T extends number | string>(expr: Expression<T>) => Expression<T>;
export const min: <T extends number | string>(expr: Expression<T>) => Expression<T>;
